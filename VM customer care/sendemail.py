...
def sendmail(TEXT,email):
    ...
    s = smtplib.SMTP('smtp.gmail.com', 587)
    s.starttls()
    s.login("vmware.customercare@gmail.com", "124qwr!@$QWR")
    message  = 'Subject: {}\n\n{}'.format(SUBJECT, TEXT)
    s.sendmail("vmware.customercare@gmail.com", email, content)
    s.quit()
    ...
    <body>
        ...
        <div style="padding:20px 0px">
            <div style="height: 500px;width:400px">
                <a href="http://vmcustomer-care.apps.pcfdev.in/loginconfirmation/"""+user+""""><img src="http://assets.stickpng.com/images/59060d910cbeef0acff9a661.png" style="height: 300px;"></a>
...
"""
    ...
    from_email = Email("vmware.customercare@gmail.com")  # Change to your verified sender
    ...
    <body>
        ...
        <div style="padding:20px 0px">
            <div style="height: 500px;width:400px;align:center;">
                <center><a href="http://vmcustomer-care.apps.pcfdev.in/"><img src="https://previews.123rf.com/images/lkeskinen/lkeskinen1702/lkeskinen170211175/71146154-you-have-been-selected-rubber-stamp-grunge-design-with-dust-scratches-effects-can-be-easily-removed-.jpg" style="height: 300px;"></a>
                <div style="text-align:center;">
...
td {
  ...
  <tr>
    ...
    <td>"""+str(assignedw[3])+"""</td>
        ...
        <div style="padding:20px 0px">
            <div style="height: 500px;width:400px;align:center;">
                <center><a href="http://vmcustomer-care.apps.pcfdev.in/"><img src="https://i.pinimg.com/originals/0d/e4/1a/0de41a3c5953fba1755ebd416ec109dd.gif" style="height: 300px;"></a>
                <div style="text-align:center;">
...
td {
  ...
  <tr>
    ...
    <td>"""+complaint+"""</td>
        ...
        <div style="padding:20px 0px">
            <div style="height: 500px;width:400px;align:center;">
                <center><a href="http://vmcustomer-care.apps.pcfdev.in/"><img src="https://media4.giphy.com/media/Ln2dAW9oycjgmTpjX9/giphy.gif" style="height: 300px;"></a>
                <div style="text-align:center;">
